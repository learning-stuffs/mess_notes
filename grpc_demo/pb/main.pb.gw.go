...
/*
Package wardrobe is a reverse proxy.
...
func request_Login_Hello_0(ctx context.Context, marshaler runtime.Marshaler, client LoginClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterLoginHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LoginClient) error {
	...
	mux.Handle("POST", pattern_Login_Hello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Login_Hello_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Login_Hello_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Login_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "account"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Login_Hello_0 = runtime.ForwardResponseMessage
)
